...
# -------------------------------------------------------------------------
import numpy as np
from laws.management_modules import globals

from laws.management_modules.replace_pcr import npareatotal, npareamaximum
from laws.management_modules.data_handling import returnBool, binding, cbinding, loadmap, divideValues, checkOption, \
    npareaaverage, readnetcdf2
from laws.hydrological_modules.water_demand.domestic import waterdemand_domestic
from laws.hydrological_modules.water_demand.industry import waterdemand_industry
from laws.hydrological_modules.water_demand.livestock import waterdemand_livestock
from laws.hydrological_modules.water_demand.irrigation import waterdemand_irrigation
from laws.hydrological_modules.water_demand.irrigation_crops import waterdemand_irrigation_crops
from laws.hydrological_modules.water_demand.environmental_need import waterdemand_environmental_need
from laws.hydrological_modules.water_demand.wastewater import waterdemand_wastewater
...
class water_demand:
    ...
    **Functions**
    ...
    def initial(self):
        ...
        # crop_coupling is configured by LAWSModel_ini before this method is
        # called. Select one irrigation implementation for the entire run;
        # all later initial() and dynamic() calls use this shared interface.
        if self.var.crop_coupling:
            self.irrigation = waterdemand_irrigation_crops(self.model)
        else:
            self.irrigation = waterdemand_irrigation(self.model)
    ...
    def dynamic(self):
        ...
        * get non-Irrigation water demand and its return flow fraction
        ...
        if checkOption('includeWaterDemand'):
            ...
            # print("act_irrConsumption:",round(self.var.act_irrConsumption[3][3448]*1000,3))
            if self.var.modflow:
