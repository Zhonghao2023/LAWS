...
class LAWSModel_dyn(DynamicModel):

    # =========== DYNAMIC ====================================================

    def dynamic(self):
        """
        Dynamic part of LAWS
        ...
        # This delegates evaporation to the implementation selected during
        # initialization: CWatM evaporation or LAWS crop evaporation.
        self.landcoverType_module.dynamic()
        timemeasure("Soil main")  # 5. timing
        if self.var.crop_coupling:
            self.BioMassCalc_module.dynamic()
